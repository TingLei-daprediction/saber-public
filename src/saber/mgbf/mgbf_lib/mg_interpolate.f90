...
!$omp parallel do private(n,i,x1,x2,x3,x4,x,x1x,x2x,x3x,x4x,rx2x1,rx3x1,rx4x1,rx3x2, &
!$omp& rx4x2,rx4x3,CFL1,CFL2,CFL3,CLL,CFR1,CFR2,CFR3,CRR) schedule(static)
   do n=1,this%nm
     i=this%iref(n)
     x1=xf(i)
     x2=xf(i+1)
...
!$omp parallel do private(m,j,y1,y2,y3,y4,y,y1y,y2y,y3y,y4y,ry2y1,ry3y1,ry4y1,ry3y2, &
!$omp& ry4y2,ry4y3,CFL1,CFL2,CFL3,CLL,CFR1,CFR2,CFR3,CRR) schedule(static)
   do m=1,this%mm
     j=this%jref(m)
     y1=yf(j)
     y2=yf(j+1)
