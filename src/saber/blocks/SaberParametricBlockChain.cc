...
void SaberParametricBlockChain::multiply(oops::FieldSet4D & fset4d) const {
  util::Timer timer("saber::SaberParametricBlockChain", "multiply");
  ...
  {
    util::Timer centralTimer("saber::SaberParametricBlockChain", "centralBlockMultiply");
    if (crossTimeCov_) {
      ...
      // Reference in section 3.4.2. of
      // https://rmets.onlinelibrary.wiley.com/doi/full/10.1002/qj.2325.
      // Local sum of x1, x2, ...
